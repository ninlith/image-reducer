...
# Load the image
original_image = Image.open("input/1.jpg")
...
#resized_image.save("output/resized_image.png")
resized_image.save(
    "output/resized_image.avif", 
...
resized_image.save(
    "output/resized_image.webp", 
    quality=70,             # quality level (0-100)  
    method=6,
)
...
import os
print(os.stat("output/resized_image.avif").st_size)
print(os.stat("output/resized_image.webp").st_size)